...
type RotationMap = Record<StickerColor, Partial<Record<StickerColor, string>>>;
...
} as const satisfies { edges: EdgeIndexMap; corners: CornerIndexMap };
